...
For minor changes, i.e. schema changes that are just a few lines, you can elimintate churn and skip these steps and make your changes directly in the **Main** branch. As admin, you OWN your own changes so be extra careful when doing this.
